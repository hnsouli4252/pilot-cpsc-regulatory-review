...
const HAZARD_DOMAINS=[
 {label:"Electrical",words:["electric","electrical","electrocution","shock","battery","voltage","wiring","charger"]},
 {label:"Mechanical",words:["mechanical","moving part","structural","breakage","crush","pinch","impact"]},
 {label:"Thermal",words:["thermal","temperature","overheat","hot surface","burn","scald"]},
 {label:"Chemical",words:["chemical","corrosive","solvent","acid","alkali","leak","exposure"]},
 {label:"Fire/Explosion",words:["fire","flame","flammable","combust","ignite","explosion","explode","blast"]},
 {label:"Choking/Ingestion",words:["chok","ingest","swallow","small part","aspirat"]},
 {label:"Laceration",words:["lacerat","cut ","sharp edge","puncture","blade"]},
 {label:"Fall/Tip-over",words:["fall","tip-over","tip over","tipping","unstable","rollover"]},
 {label:"Entrapment/Strangulation",words:["entrap","strang","suffocat","cord","wedg","pinning"]},
 {label:"Toxicological",words:["toxic","toxicity","poison","carcinogen","lead","phthalate","inhalation"]},
 {label:"Labeling/Instruction",words:["label","warning","instruction","manual","disclosure","marking"]},
];
const hazardTags=(evidence:string)=>{const lower=evidence.toLowerCase(),tags=HAZARD_DOMAINS.filter(d=>d.words.some(w=>lower.includes(w))).map(d=>d.label);return tags.length?tags:["Unclear/Needs review"]};
